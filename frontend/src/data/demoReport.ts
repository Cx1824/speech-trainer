...
export const DEMO_REPORT: ReportData = {
  ...
  axes: [
    {
      key: 'continuity',
      label: '表达连贯性',
      description: '依据口癖、紧邻重复和局部表达断裂评价',
      score: 82,
      weight: 10,
      source: 'signal',
      feedback: '表达整体连贯，少量口癖和紧邻重复略微影响了顺畅度。',
      evidence: [
        '有效表达 294 字；明确口癖 3 次。',
        '紧邻用词重复率 8.0%；局部表达断裂 0 处。',
      ],
    },
    {
      key: 'pacing',
      label: '语速与节奏',
      description: '依据真实发言速率和有文本断裂佐证的停顿密度评价',
      score: 76,
      weight: 10,
      source: 'signal',
      feedback: '平均语速处于清晰表达区间，停顿略有波动但未形成明显断裂。',
      evidence: [
        '真实发言 94.0 秒，平均语速 188 字/分。',
        '正文短停顿 4 次；正文长停顿 2 次，首尾等待不计入。',
      ],
    },
    {
    ...
    {
      key: 'evidence_results',
      label: '案例、行动与结果证据',
      description: '是否提供本人行动、结果、难点与可核查指标',
      score: 79,
      weight: 20,
      source: 'llm',
      feedback: '结果指标清楚，也区分了本人推进动作；方案比较还可以更完整。',
      evidence: [
        '“我负责梳理需求并推动设计、研发一起完成改版。”',
        '“核心流程完成率从 62% 提升到 78%。”',
      ],
    },
    {
    ...
    },
    {
      ...
      label: '追问响应',
      description: '面对追问时能否补充新证据并直接回应质疑',
      score: 77.5,
      weight: 10,
      source: 'llm',
      feedback: '能够解释选择依据并补充对比信息，但风险取舍还可以再具体。',
      evidence: ['“我们比较了完整重构和分步改版，最后选择先修复流失最高的两个节点。”'],
    },
  ],
  expression_metrics: {
    speech_rate: 188,
  ...
  dialogues: [
    ...
    },
    {
      ...
      role: 'ai',
      stage: 'project',
      text: '为什么选择这个方案，而不是一次性重构？',
    },
    {
      seq: 4,
      role: 'user',
      stage: 'project',
      text: '我们比较了完整重构和分步改版，最后选择先修复流失最高的两个节点，用两周数据决定是否继续扩大范围。',
    },
  ],
}
